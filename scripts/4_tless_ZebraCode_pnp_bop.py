...
dir_suffix = "ablation_pnp"
output_file_name = "SymNetZebraCodepbrablationpnp_tless-test.csv"
...
if RUN_EVALUATE:
    ...
    for eval_folder in eval_folders:
        command = f"python core/symn/ablation_run_evaluate_pnp.py --eval_folder {os.path.join(folder_path, eval_folder)} --ckpt best --detection zebrapose_detections/tless/tless_bop_pbr_only.json"
