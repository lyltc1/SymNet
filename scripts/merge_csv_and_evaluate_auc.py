""" copy all the csv file and generate SymNetPbr_ycbv-test.csv """
import os
import sys
...
# this is used for boptoolkit to find BOP dataset
os.environ['BOP_PATH'] = '/home/lyl/git/SymNet/datasets/BOP_DATASETS'
...
folder_path = "/home/Symnet/output/"
