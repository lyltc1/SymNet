...
from core.symn.datasets.BOPDataset_utils import build_BOP_test_dataset, batch_data_test, build_BOP_train_dataset
...
def main():
    ...
    data_test = build_BOP_train_dataset(cfg, cfg.DATASETS.TEST, debug=cfg.DEBUG)
