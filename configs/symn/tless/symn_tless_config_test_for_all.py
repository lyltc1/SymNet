...
DATASETS = dict(
    NAME="tless",
    TRAIN=("train_primesense", "train_pbr"),  # tuple, which is the subset of ("pbr", "real",)
    TEST=("test_primesense",),
    TEST_KEYFRAME="tless_test_targets_all.json",  # choose from [None, "test_targets_bop19.json",
                                                  #             "ycbv_test_targets_keyframe.json"]
    TEST_DETECTION_TYPE="type2",  # choose from ["type1" for yolox, "type2" for maskrcnn, "type3"]
    TEST_DETECTION_PATH='gdrnpp_yolox_detections/tless/test/test_bboxes/yolox_tless_real_pbr_test_all.json.json',
