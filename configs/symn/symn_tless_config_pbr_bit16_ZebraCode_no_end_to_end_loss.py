...
MODEL = dict(
    ...
    PNP_NET=dict(
        ...
        SITE_Z_LW=0.000,  # because the unit is mm
...
DATASETS = dict(
    ...
    CODE_TYPE="ZebraCode",  # choose from ["ZebraCode", "SymCode"]
    TEST_DETECTION_TYPE="type1",  # choose from ["type1" for yolox, "type2" for maskrcnn, "type3"]
    # TEST_DETECTION_PATH='zebrapose_detections/tless/tless_bop_pbr_only.json',
